...
import { LuChevronLeft, LuCalendar, LuChevronDown, LuCamera, LuSave, LuWallet } from 'react-icons/lu';
...
export default function ExpensesPage() {
    ...
    return (
        <div className="bg-brand-white font-display text-primary min-h-screen flex flex-col items-center p-0 m-0">
            <div className="relative flex min-h-screen w-full max-w-[480px] flex-col bg-brand-white shadow-2xl">
                <header className="sticky top-0 z-50 bg-brand-white border-b border-primary/10">
                    <div className="flex items-center p-4 justify-between w-full">
                        ...
                        <h1 className="text-primary text-lg font-extrabold leading-tight tracking-[-0.015em] flex-1 text-center uppercase">Input Pengeluaran</h1>
                ...
                <main className="flex-1 flex flex-col w-full overflow-y-auto pb-32">
                    <div className="px-4 py-4">
                        <div className="flex h-12 w-full items-center justify-center rounded-xl bg-primary/10 p-1">
                            <Link href="/sales" className="flex h-full grow items-center justify-center overflow-hidden rounded-lg px-2 text-primary/60 text-sm font-bold transition-all hover:bg-primary/5">
                    ...
                    <form onSubmit={handleSubmit} className="flex flex-col gap-5 px-4 py-2">
                        ...
                        <label className="flex flex-col gap-2">
                            ...
                            <input
                                ...
                                placeholder="Contoh: Beli Pisang 10 Sisir"
                                type="text"
                                value={description}
                        ...
                        <label className="flex flex-col gap-2">
                            ...
                            <div className="relative group">
                                ...
                                >
                                    ...
                                    <option value="Bahan Baku">Bahan Baku (Pisang, Tepung)</option>
                                    <option value="Topping & Selai">Topping & Selai</option>
                                    <option value="Kemasan">Kemasan/Packaging</option>
                                    <option value="Operasional Outlet">Operasional Outlet</option>
